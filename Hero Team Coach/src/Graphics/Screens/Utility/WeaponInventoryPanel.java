...
public class WeaponInventoryPanel extends JPanel {
	...
	public WeaponInventoryPanel() {
		...
		if (TeamBlacksmithScreen.showWeapons) {
		...
		rowPanel.add(traitsPanel);
			...
			for (int i = 0; i < ArmourInventory.armourInventoryList.size(); i++) {
				...
				rowPanel.add(namePanel);
					...
					JLabel nameLabel = new JLabel();
					nameLabel.setText(ArmourInventory.armourInventoryList.get(i).name);
					namePanel.add(nameLabel);
				...
				rowPanel.add(typePanel);
					...
					JLabel typeLabel = new JLabel();
					typeLabel.setText(ArmourInventory.armourInventoryList.get(i).armourType.name);
					typePanel.add(typeLabel);
				...
				rowPanel.add(materialPanel);
					...
					JLabel materialLabel = new JLabel();
					materialLabel.setText(ArmourInventory.armourInventoryList.get(i).material.name);
					materialPanel.add(materialLabel);
				...
				rowPanel.add(qualityPanel);
					...
					JLabel qualityLabel = new JLabel();
					qualityLabel.setText(ArmourInventory.armourInventoryList.get(i).quality.name);
					qualityPanel.add(qualityLabel);
				...
				rowPanel.add(combatPanel);
					...
					JLabel combatLabel = new JLabel();
					combatLabel.setText(Integer.toString(ArmourInventory.armourInventoryList.get(i).combatBonus));
					combatPanel.add(combatLabel);
				...
				rowPanel.add(skillPanel);
					...
					JLabel skillLabel = new JLabel();
					skillLabel.setText(Integer.toString(ArmourInventory.armourInventoryList.get(i).skillBonus));
					skillPanel.add(skillLabel);
				...
				rowPanel.add(intelligencePanel);
					...
					JLabel intelligenceLabel = new JLabel();
					intelligenceLabel.setText(Integer.toString(ArmourInventory.armourInventoryList.get(i).intelligenceBonus));
					intelligencePanel.add(intelligenceLabel);
				...
				rowPanel.add(personalityPanel);
					...
					JLabel personalityLabel = new JLabel();
					personalityLabel.setText(Integer.toString(ArmourInventory.armourInventoryList.get(i).personalityBonus));
					personalityPanel.add(personalityLabel);
